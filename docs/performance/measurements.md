...
marked-up phrasing still dialect; callout / list-in-quote / marked quotes still dialect.
Nested plain quotes and same-family nested lists (any depth) are engine-owned (flagged). Kind-aware
