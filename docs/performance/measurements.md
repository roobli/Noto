...
underscore·nested marks / collapsible·titled callout edges still (no-`>` lazy +
list lazy + simple marked phrasing owned with `@roobli/md` ≥ v0.1.9); dialect. Nested plain quotes, simple lists-in-quotes, plain-body GFM alerts /
