...
ragged tables, and heavy inline (deep / ambiguous nested marks, wiki, reference
links, bare autolinks, HTML, escapes) stay on dialect. Empty footnote bodies, same-family nests at
...
marks), and **simple inline links / images** (`[text](url)`, `![alt](url)`,
optional title; plain or simple-marked link text) are engine-owned.
...
deeper mark nests / wiki / reference links), then reconsider
...
simple-underscore-emphasis, simple-nested-marks, simple-inline-links, simple-gfm-tables,
