...
ragged tables, and heavy inline (deep / ambiguous nested marks, www /
email, HTML, escapes, nested-bracket wiki) stay on dialect.
...
http(s) autolinks**, **simple angle-bracket http(s) autolinks**, and **simple wiki links** (`[[target]]` / `[[target|alias]]` as literal text; decoration
...
deeper mark nests / www+email / HTML / escapes), then reconsider
...
simple-underscore-emphasis, simple-nested-marks, simple-inline-links, simple-bare-autolinks, simple-angle-autolinks, simple-reference-links, simple-wiki-links, simple-gfm-tables,
