...
email / angle-bracket autolinks, HTML, escapes, nested-bracket wiki) stay on dialect.
...
http(s) autolinks**, and **simple wiki links** (`[[target]]` / `[[target|alias]]` as literal text; decoration
...
deeper mark nests / www+email / angle-bracket autolinks / HTML / escapes), then reconsider
...
simple-underscore-emphasis, simple-nested-marks, simple-inline-links, simple-bare-autolinks, simple-reference-links, simple-wiki-links, simple-gfm-tables,
