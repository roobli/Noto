...
| `simple-eighteen-level-nested-marks.md` | eighteen-level nested marks (`*i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i*`, `**i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i**`) in para/heading/list/table/callout/footnote; nineteen-/twenty-/twenty-one-/twenty-two-/twenty-three-level in `simple-nineteen-level-nested-marks.md` / `simple-twenty-level-nested-marks.md` / `simple-twenty-one-level-nested-marks.md` / `simple-twenty-two-level-nested-marks.md` / `simple-twenty-three-level-nested-marks.md`; `***` / same-delimiter / twenty-four+ stay dialect |
| `simple-nineteen-level-nested-marks.md` | nineteen-level nested marks (`_h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_`, `_h **i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i** h_`) in para/heading/list/table/callout/footnote; twenty-/twenty-one-/twenty-two-/twenty-three-level in `simple-twenty-level-nested-marks.md` / `simple-twenty-one-level-nested-marks.md` / `simple-twenty-two-level-nested-marks.md` / `simple-twenty-three-level-nested-marks.md`; `***` / same-delimiter / twenty-four+ stay dialect |
| `simple-twenty-level-nested-marks.md` | twenty-level nested marks (`**g _h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_ g**`, `*g _h **i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i** h_ g*`) in para/heading/list/table/callout/footnote; twenty-one-/twenty-two-/twenty-three-level in `simple-twenty-one-level-nested-marks.md` / `simple-twenty-two-level-nested-marks.md` / `simple-twenty-three-level-nested-marks.md`; `***` / same-delimiter / twenty-four+ stay dialect |
| `simple-twenty-one-level-nested-marks.md` | twenty-one-level nested marks (`*f **g _h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_ g** f*`, `**f *g _h **i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i** h_ g* f**`) in para/heading/list/table/callout/footnote; twenty-two-/twenty-three-level in `simple-twenty-two-level-nested-marks.md` / `simple-twenty-three-level-nested-marks.md`; `***` / same-delimiter / twenty-four+ stay dialect |
| `simple-twenty-two-level-nested-marks.md` | twenty-two-level nested marks (`_e *f **g _h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_ g** f* e_`, `_e **f *g _h **i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i** h_ g* f** e_`) in para/heading/list/table/callout/footnote; twenty-three-level in `simple-twenty-three-level-nested-marks.md`; `***` / same-delimiter / twenty-four+ stay dialect |
| `simple-twenty-three-level-nested-marks.md` | twenty-three-level nested marks (`**d _e *f **g _h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_ g** f* e_ d**`, `*c _e **f *g _h **i _j *k **l _m *n **o _p *em **bold ~~del _x *y _z *w _v *u _t `a` t_ u* v_ w* z_ y* x_~~ more** rest* p_ o** n* m_ l** k* j_ i** h_ g* f** e_ c*`) in para/heading/list/table/callout/footnote; `***` / same-delimiter / twenty-four+ stay dialect |
