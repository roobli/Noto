...
| `simple-marked-phrasing.md` | flat `**` / `*` / `~~` / `` ` `` marks in paragraphs, headings, lists, tables, callouts, footnotes; underscore covered separately; one-/two-/three-/four-level nest in `simple-nested-marks.md` / `simple-two-level-nested-marks.md` / `simple-three-level-nested-marks.md` / `simple-four-level-nested-marks.md`; no links / wiki |
...
| `simple-nested-marks.md` | one-level nested marks (`**bold _em_**`, `*em **strong** em*`, `` **`code`** ``) in para/heading/list/table/callout/footnote; two-/three-/four-level in sibling fixtures; `***` / same-delimiter / five+ / links / wiki stay dialect |
| `simple-two-level-nested-marks.md` | two-level nested marks (`**bold *em ~~strike~~ more* bold**`, `*em **bold _nested_** more*`, code inside nested em) in para/heading/list/table/callout/footnote; three-/four-level in sibling fixtures; `***` / same-delimiter / five+ stay dialect |
| `simple-three-level-nested-marks.md` | three-level nested marks (`**a *b ~~c _d_ c~~ b* a**`, `~~del **bold *em* rest** del~~`) in para/heading/list/table/callout/footnote; four-level in `simple-four-level-nested-marks.md`; `***` / same-delimiter / five+ stay dialect |
| `simple-four-level-nested-marks.md` | four-level nested marks (`**a *b ~~c _d `e` d_ c~~ b* a**`, `*em **bold ~~del _x `y` x_~~ more** rest*`) in para/heading/list/table/callout/footnote; `***` / same-delimiter / five+ stay dialect |
