...
| `simple-nested-marks.md` | one-level nested marks (`**bold _em_**`, `*em **strong** em*`, `` **`code`** ``) in para/heading/list/table/callout/footnote; two-/three-/four-/five-/six-/seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ / links / wiki stay dialect |
| `simple-two-level-nested-marks.md` | two-level nested marks (`**bold *em ~~strike~~ more* bold**`, `*em **bold _nested_** more*`, code inside nested em) in para/heading/list/table/callout/footnote; three-/four-/five-/six-/seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ stay dialect |
| `simple-three-level-nested-marks.md` | three-level nested marks (`**a *b ~~c _d_ c~~ b* a**`, `~~del **bold *em* rest** del~~`) in para/heading/list/table/callout/footnote; four-/five-/six-/seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ stay dialect |
| `simple-four-level-nested-marks.md` | four-level nested marks (`**a *b ~~c _d `e` d_ c~~ b* a**`, `*em **bold ~~del _x `y` x_~~ more** rest*`) in para/heading/list/table/callout/footnote; five-/six-/seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ stay dialect |
| `simple-five-level-nested-marks.md` | five-level nested marks (`**v *w ~~x _y *z `a` z* y_ x~~ w* v**`, `*em **bold ~~del _x *y `z` y* x_~~ more** rest*`) in para/heading/list/table/callout/footnote; six-/seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ stay dialect |
| `simple-six-level-nested-marks.md` | six-level nested marks (`**u *v ~~w _x *y _z `a` z_ y* x_ w~~ v* u**`, `*em **bold ~~del _x *y _z `a` z_ y* x_~~ more** rest*`) in para/heading/list/table/callout/footnote; seven-/eight-/nine-level in sibling fixtures; `***` / same-delimiter / ten+ stay dialect |
| `simple-seven-level-nested-marks.md` | seven-level nested marks (`**t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t**`, `*em **bold ~~del _x *y _z *w `a` w* z_ y* x_~~ more** rest*`) in para/heading/list/table/callout/footnote; eight-/nine-level in `simple-eight-level-nested-marks.md` / `simple-nine-level-nested-marks.md`; `***` / same-delimiter / ten+ stay dialect |
| `simple-eight-level-nested-marks.md` | eight-level nested marks (`**s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s**`, `*em **bold ~~del _x *y _z *w _v `a` v_ w* z_ y* x_~~ more** rest*`) in para/heading/list/table/callout/footnote; nine-level in `simple-nine-level-nested-marks.md`; `***` / same-delimiter / ten+ stay dialect |
| `simple-nine-level-nested-marks.md` | nine-level nested marks (`*r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r*`, `**em *bold ~~del _x *y _z *w _v *u `a` u* v_ w* z_ y* x_~~ more* rest**`) in para/heading/list/table/callout/footnote; `***` / same-delimiter / ten+ stay dialect |
