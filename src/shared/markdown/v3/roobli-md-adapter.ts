 ...
 * leaf / plain paragraph+heading / simple quote / flat or one-level nested list / simple table skip mdast (IR → PM via `pm/from-engine.ts`).
 *
 ...
 * link-definition / plain paragraph+heading / simple-quote / flat-or-one-level-nested-list spans (IR → final stand-in + semanticKey, no
 ...
 * simple-quote / flat-or-one-level-nested-list indices past the first-paint prefix are marked enriched immediately — IR → PM needs no mdast.
 */
 ...
 * Engine-owned leaf / link-definition / plain phrasing / simple quotes / flat or one-level nested lists / simple tables get a final semanticKey so enrich can skip them.
 */
