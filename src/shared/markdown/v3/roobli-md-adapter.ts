 ...
 * Engine-owned leaf / link-definition / plain phrasing / simple quotes (incl. nested plain) / flat or nested lists (incl. mixed-marker) / simple tables get a final semanticKey so enrich can skip them.
 */
