...
/** Max nest depth (22 = outer + twenty-two nested, e.g. `_e *f **g _h *i **j _k *l **m _n *o **p _q *r **s _t *u ~~v _w *x _y *z `a` z* y_ x* w_ v~~ u* t_ s** r* q_ p** o* n_ m** l* k_ j** i* h_ g** f* e_`). */
const MAX_MARK_NEST = 22;
